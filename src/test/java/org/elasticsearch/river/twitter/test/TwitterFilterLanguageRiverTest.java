 ...
 */
public class TwitterFilterLanguageRiverTest extends TwitterRiverAbstractTest {

    public static void main(String[] args) throws InterruptedException, IOException {
        TwitterFilterLanguageRiverTest instance = new TwitterFilterLanguageRiverTest();
